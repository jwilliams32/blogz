...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://build-a-blog:buildablog@localhost:3306/build-a-blog'#mysql connection,how we will connect,user,user password,host,port#,database you want to connect to
