      ...
      #  if blog_id:
       ...
       #     blogs = Blog.query.get(blog_id)
        ...
        #    return render_template('blogpost.html', title="Blog Post!", blog= Blog.query.get(blog_id))
         ...
         #   flash("User already taken", "error")
        ...
        if not existing_user: 
            ...
            return flash("User Exist","error")        #flash("User name or Password not 3-20 characters or Passwords do not match","error")
...
def newpost():
    ...
    if request.method == 'POST':#if incoming request is a post, todo submit
        ...
        if not title_error and not body_error:
            ...
            return render_template('post.html', title_error=title_error,body_error=body_error, title=title, body=body,owner=owner)
    else:
