...
#    
    ...
    return render_template('signup.html',username_error=username_error,username = username, password = password,
                            verify=verify,password_error=password_error, verify_error=verify_error)
