...
def blog():
    if request.method == 'GET':
        ...
        if owner_id:
            ...
            return render_template('singleUser.html', title="Single User", user= User.query.get(owner_id))   
        else:
...
def index():
    if request.args.get('user')
        ...
        return render_template('singleUser.html', title="Single User", user= User.query.all(id))   
