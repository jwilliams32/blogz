...
#    
      ...
      #  if blog_id:
       ...
       #     blogs = Blog.query.get(blog_id)
        ...
        if existing_user == new_user:
            ...
            if ' ' in new_user or len(new_user) < 3 or len(new_user) > 20:
    ...
    return render_template('signup.html',username_error=username_error,new_user=new_user)#, username = username, password = password,
